...
- [X] Adapt grammar
- [X] Adapt semantics
** TODO Support commodity directive [2/5]
...
- [ ] include a 1k markers and radix in parse result of amount (as separate entities)
- [ ] Add integration tests for all four commodity directives
