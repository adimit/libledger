...
- [X] Adapt grammar
- [X] Adapt semantics
** TODO Support commodity directive [7/12]
...
- [X] Add test sfor parsing commodity statements
- [ ] Tests for necessarilyseparatedby: =a,a= success. =a,a,= success iff flag is set, =a,a= includeseps true/false, =a= failure, =a,b= failure
- [ ] Implement necessarily separated by extension
- [ ] Find a different way to fix transfer of information from account parser to commodity parser
